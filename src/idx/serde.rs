...
pub mod sr_u64 {
    ...
    pub fn serialize<S, const D: usize>(v: &[StrengthReducedU64; D], s: S) -> Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
...
pub mod chunks_u64s {
    ...
    pub fn serialize<S, const D: usize>(chunks: &Cow<'_, [Chunk<D>]>, s: S) -> Result<S::Ok, S::Error>
        where
            S: Serializer,
            ...
            [ULE; D]: std::array::LengthAtMost32,
        {
            ...
            let slice: &[u8] = Chunk::<D>::slice_as_u64s(chunks.borrow()).as_bytes();
            serde_bytes::serialize(slice, s)
        }

    pub fn deserialize<'de: 'a, 'a, D, const DE: usize>(d: D) -> Result<Cow<'a, [Chunk<DE>]>, D::Error>
        where
            D: Deserializer<'de>,
            [u64; DE]: std::array::LengthAtMost32,
            [ULE; DE]: std::array::LengthAtMost32,
        {
